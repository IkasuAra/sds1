...
@Table(name = "tb_record")   //mapear a tabela do banco de dados com o nome tb_genre
public class Record implements Serializable {	 //interface serializable (conversão de bites para o tráfego na rede)
	...
	@ManyToOne
	@JoinColumn(name = "game_id")		//associar classe Record ao Game
	private Game game;
