...
public class RecordDTO  implements Serializable {	 //interface serializable (conversão de bites para o tráfego na rede)
	...
	public RecordDTO(Record entity) {	//instanciar o RecordDTO dos dados já monitorados
		id = entity.getId();
